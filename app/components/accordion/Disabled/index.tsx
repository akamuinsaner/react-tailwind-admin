...
import { ArrowDownIcon, ChevronDownIcon, BarsArrowDownIcon } from '@heroicons/react/24/outline';
            ...
            <CardBody>
                <Accordion>
                    <AccordionPanel name="frontend">
                        <AccordinHeader disabled expandIcon={<ArrowDownIcon />}>Front End Developer</AccordinHeader>
                        <AccordionBody>
                    ...
                    <AccordionPanel name="backend">
                        <AccordinHeader expandIcon={<ChevronDownIcon />}>Backend Developer</AccordinHeader>
                        <AccordionBody>
                    ...
                    <AccordionPanel name="fullstack">
                        <AccordinHeader expandIcon={<BarsArrowDownIcon />}>Full Stack Developer</AccordinHeader>
                        <AccordionBody>
