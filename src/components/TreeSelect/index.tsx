...
import { getTreeDataFormatted } from '../Cascader/utils';
import DropBox from './DropBox';
import Options from './Options';
import useTag from '../Cascader/useTag';
import useValue from '../Cascader/useValue';
...
export type RTTreeSelectOption = RTCascaderOption;

export type RTTreeSelectProps = {
...
const TreeSelect: FC<RTTreeSelectProps> = ({
    ...
    const tags = useTag<RTTreeSelectOption>({
        value,
        tagLimit,
        size,
        valueOnChange,
    ...
    const { display, displayIcon, showHolder } = useInput<RTTreeSelectOption>({
        searchValue,
        wrapper,
        multiple,
        value,
    ...
    const { onInputChange, searchData, noData } = useSearch<RTTreeSelectOption>(
        {
            searchValue,
            onSearch,
            flattedData,
