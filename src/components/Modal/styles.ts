...
export const styles: RTModalTypes = {
    base: `rounded bg-main relative top-1/4 m-auto w-[600px] pointer-events-all overflow-hidden break-inside-avoid`,
    mask: `bg-black/45 fixed inset-0 pointer-events-none z-50 transition-[opacity] opacity-0 
            duration-200 ease-linear`,
    wrap: `fixed inset-0 pointer-events-all z-50 cursor-pointer transition-[transform] scale-0 origin-bottom-left
            duration-200 ease-linear`,
