...
const DatePickerPanelHeader = ({
    ...
    return (
        <div className={styles.panel.header.base} onClick={e => {
            ...
            <ChevronLeftIcon onClick={prevMonth} className={styles.panel.header.icon} />
            ...
            <ChevronRightIcon onClick={afterMonth} className={styles.panel.header.icon} />
    ...
    const itemClassName = (item: any) => {
        ...
        return twMerge(
            ...
            classNames({
                ...
                [styles.panel.year.selected]: current.year > item.start && current.year < item.end,
                [styles.panel.body.outOfRange]: filterByLimit
            })
        )
    }
