...
export const styles: RTAccordionStyles = {
    ...
    header: {
        base: 'flex w-full items-center justify-between py-4 px-6 font-semibold text-base cursor-pointer border-b select-none',
        disabled: 'flex w-full items-center justify-between py-4 px-6 font-semibold text-base cursor-pointer border-b select-none bg-disableBg text-disableText'
    },
    icon: {
