...
export const styles: RTModalTypes = {
    base: `rounded text-mainText bg-main relative m-auto pointer-events-all overflow-hidden 
        break-inside-avoid transition-[transform] fixed z-50 duration-200 ease-linear`,
    mask: `bg-black/45 fixed inset-0 pointer-events-all z-50 transition-[opacity] opacity-0 
